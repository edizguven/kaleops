                    ...
                    <div class="mb-6 p-4 bg-amber-50 border-2 border-amber-200 rounded-xl">
                        ...
                        <div class="flex flex-wrap gap-6">
                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="assign_cam" value="1" <?php echo e(old('assign_cam', true) ? 'checked' : ''); ?> class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="font-medium text-gray-700">CAM</span>
                            </label>
                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="assign_lazer" value="1" <?php echo e(old('assign_lazer', true) ? 'checked' : ''); ?> class="rounded border-gray-300 text-red-600 focus:ring-red-500">
                                <span class="font-medium text-gray-700">Lazer</span>
                            </label>
                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="assign_cmm" value="1" <?php echo e(old('assign_cmm', true) ? 'checked' : ''); ?> class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
...
<?php endif; ?><?php /**PATH /Users/edizguven/Desktop/KaleSavunma/public_html/resources/views/admin/jobs/index.blade.php ENDPATH**/ ?>