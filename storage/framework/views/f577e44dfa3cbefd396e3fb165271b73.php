                        ...
                        <div class="p-6">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                                ...
                                <div class="flex space-x-3 mt-4 md:mt-0">
                                    <a href="<?php echo e(asset('storage/' . $job->image_path)); ?>" target="_blank" class="flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-blue-600 hover:text-white transition font-bold text-sm border border-gray-300">
                                    ...
                                    <a href="<?php echo e(asset('storage/' . $job->pdf_path)); ?>" target="_blank" class="flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-red-600 hover:text-white transition font-bold text-sm border border-gray-300">
...
<?php endif; ?><?php /**PATH /Users/edizguven/Desktop/total/KaleSavunma/resources/views/operator/index.blade.php ENDPATH**/ ?>